          ...
          {cart.length > 0 ? (
            cart.map((prod) => (
              <div
                ...
                className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-darkIvory rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 mb-4 border border-gray-100"
              >
                {/* Product Image */}
                <img
                  src={prod.image}
